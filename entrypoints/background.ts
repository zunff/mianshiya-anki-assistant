  ...
  "cards": [
    {
      ...
      "back": "<h3>核心结论</h3><p><strong>transient</strong> 用于让字段在序列化时被忽略，避免不该持久化的数据进入字节流。</p><h3>结构骨架</h3><ul><li>作用：阻止字段被序列化</li><li>场景：敏感信息 / 临时状态</li><li>边界：只影响序列化结果，不影响对象本身</li></ul>",
      "tags": ["Java","序列化","八股"]
    },
    {
  ...
  "cards": [
    {
      ...
      "back": "<h3>核心结论</h3><p><strong>List</strong> 是有序、可重复的集合体系，重点在顺序和随机访问/插入删除特性。</p><h3>结构骨架</h3><ul><li><code>ArrayList</code>：数组，查询快</li><li><code>LinkedList</code>：链表，插删灵活</li><li>关注点：顺序、重复、扩容、遍历代价</li></ul>",
      "tags": ["Java","集合","八股"]
    },
    {
      "front": "Java 集合体系 - Map 体系",
      "back": "<h3>核心结论</h3><p><strong>Map</strong> 以键值对存储数据，重点在键唯一、查找效率和有序性差异。</p><h3>结构骨架</h3><ul><li><code>HashMap</code>：无序，通用</li><li><code>LinkedHashMap</code>：保持插入顺序</li><li><code>TreeMap</code>：可排序</li><li>关注点：哈希、顺序、红黑树、线程安全</li></ul>",
      "tags": ["Java","集合","八股"]
    },
    {
